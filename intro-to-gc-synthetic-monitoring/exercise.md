...
- Deployed your first Synthetic Browser Check, verifying that the QuickPizza login works like expected
...
## Exercise 2: Create your first Browser Synthetic Monitoring Check
...
### Step 2: Re-useing the QuickPizza Browser login test
